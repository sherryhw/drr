...
public final class Constants {
  ...
  public static final int DEFAULT_ARRIVAL_TIME_MEAN = 10000;
  
  public static final int MAXQUEUESIZE = 10000; //20 * 500
  public static final int DEFAULT_BANDWIDTH = 1; //250;
  
  public static final int DEFAULTQUANTUMOFSERVICE = 60;
  
  public static final boolean USE_LOG = false;
  
  public static final int SETUP_TIME = 5000000; //50000;
  
  public static final int PART_AVERAGE = 100;
  
  public static final int SIMULATION_TIME = 2000000000;
